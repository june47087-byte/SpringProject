	...
	<c:forEach var="pds" items="${bList}">
		...
		<td align="center" height="25">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/Pds/pds_view?idx=${pds.idx}&page=${page}">${pds.subject }</a></td>
				<td align="center" height="20"><font face="돋움" size="2">${pds.filename }</td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${pds.name }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${fn:substring(pds.regdate, 0, 10	)}</font></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="pds" method="post" action="/Pds/pds_list">	
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="#" onclick="pds_search(); return false;"><img src="/Images/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>

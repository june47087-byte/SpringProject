  ...
  <TD>
    <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0 WIDTH=330>
        ...
        <TD ALIGN="center">
         ...
         <BR><FONT COLOR="#483cae"><b>abcd</b></FONT>는 아직 사용되지 않은 아이디입니다.
         <BR><FONT COLOR="#483cae"><b>abcd</b></FONT>로 등록하셔도 됩니다.
    	...
    	다른 아이디를 사용하여 주십시오.
           <INPUT NAME=user_id type=text size=16 maxlength=16>
      	   <input type=image src="/Images/img/u_bt08.gif" border=0 vspace=0>
